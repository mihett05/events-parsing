...
def upgrade() -> None:
    ...
    sa.Enum("UNPROCESSED", "PROCESSED", name="MailStateEnum").create(op.get_bind())
    op.create_table(
        "events",
        ...
        sa.Column("end_registration", sa.DateTime(timezone=True), nullable=True),
...
def downgrade() -> None:
    ...
    sa.Enum("UNPROCESSED", "PROCESSED", name="MailStateEnum").drop(op.get_bind())
    # ### end Alembic commands ###
