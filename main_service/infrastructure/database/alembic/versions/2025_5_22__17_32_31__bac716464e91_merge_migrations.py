...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["organization_id"],
            ["organizations.id"],
            name=op.f("fk_user_organization_role_organization_id_organizations"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["user_id"],
    ...
    op.drop_constraint(
        "fk_notifications_recipient_id_users", "notifications", type_="foreignkey"
    )
    op.create_foreign_key(
...
def downgrade() -> None:
    ...
    op.drop_constraint(
        op.f("fk_organizations_owner_id_users"), "organizations", type_="foreignkey"
    )
    op.create_foreign_key(
    ...
    op.drop_constraint(
        op.f("fk_notifications_recipient_id_users"), "notifications", type_="foreignkey"
    )
    op.create_foreign_key(
    ...
    op.drop_constraint(
        op.f("fk_events_organization_id_organizations"), "events", type_="foreignkey"
    )
    op.create_foreign_key(
    ...
    op.drop_constraint(
        op.f("fk_attachments_event_id_events"), "attachments", type_="foreignkey"
    )
    op.create_foreign_key(
        "fk_attachments_mail_id_mails", "attachments", "mails", ["mail_id"], ["id"]
    )
    op.create_foreign_key(
        "fk_attachments_event_id_events", "attachments", "events", ["event_id"], ["id"]
    )
    op.create_table(
        "association_table",
        ...
        sa.Column(
            "role",
            postgresql.ENUM(
                "OWNER", "ADMIN", "REDACTOR", name="userroleenum", create_type=False
            ),
            autoincrement=False,
            nullable=False,
        ),
