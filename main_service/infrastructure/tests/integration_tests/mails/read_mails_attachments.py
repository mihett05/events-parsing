...
from infrastructure.gateways.notifications.gateways.mail import NotificationWithAttachmentsEmailGateway
...
async def test_create_success(
    ...
    for mail in parsed_mails:
        await mail_gateway.send_with_attachments(notification=Notification(text="Тестовое сообщение"),
