...
class CreateUserRoleUseCase:
    def __init__(self, repository: UserOrganizationRolesRepository, permission_builder: PermissionBuilder, transaction: TransactionsGateway, read_roles_use_case: ReadUserRolesUseCase,
